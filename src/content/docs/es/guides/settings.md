---
title: Ajustes
description: Configura la tipografía, la apariencia, el idioma y más en TomaNote.
---

El modal de ajustes agrupa las preferencias de la app en varias pestañas.

## Abrir ajustes

- Pulsa `Alt+S`.
- Pulsa el botón del **engranaje** en la parte inferior de la barra lateral izquierda.
- En móvil, toca **Ajustes** en la barra inferior.

Los cambios se aplican automáticamente al elegirlos; el botón **Aceptar** cierra el modal.
...
Elige la fuente del editor:

- **Inter (Por defecto)**, Poppins, Raleway, Open Sans, Roboto, Montserrat.
- **Personalizada**: pega una URL de Google Fonts (debe empezar por `https://fonts.googleapis.com/`) y la familia se carga y aplica automáticamente.
...
- **Inglés (US)** o **Español (CO)**.
- El idioma de la interfaz cambia al instante; tu elección se recuerda.

### Ancho del documento

- **Por defecto** — ancho de lectura cómodo.
- **Estrecho** — usa todo el ancho (también se alterna con `Alt+E`).
...
La pestaña Roadmap muestra las versiones publicadas y planificadas como columnas:
