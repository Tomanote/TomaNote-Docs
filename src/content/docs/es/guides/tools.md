---
title: Herramientas y barra lateral derecha
description: Las herramientas de formato y pestañas en la barra lateral derecha y la barra inferior móvil.
---
...
En pantallas pequeñas la barra lateral derecha se sustituye por una **barra inferior**. Toca el botón de un grupo (Contenido, Fuente, Pestaña) para abrir su submenú y luego toca la acción.

La barra inferior también incluye:

- **Buscar** — abre la paleta de comandos.
...
Si seleccionas texto y luego pulsas un botón de formato, tu selección se conserva y el formato se aplica donde la hiciste. Eliminar una pestaña desde las herramientas siempre abre primero el diálogo de confirmación.
