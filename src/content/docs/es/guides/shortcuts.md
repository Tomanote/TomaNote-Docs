...
description: Todos los atajos de teclado disponibles en TomaNote.
---
...
- **Solo escritorio** — los atajos se activan en dispositivos con puntero fino (ratón/trackpad); los dispositivos táctiles usan las barras de herramientas.
- **Funcionan las dos teclas Alt** — `Alt+N` funciona con la Alt izquierda o derecha.
- **Teclas de la fila superior** — la coma, el punto y los atajos numéricos usan las teclas de la fila superior; el teclado numérico se ignora para ellos.
- **AltGr en Windows** — AltGr envía Ctrl+Alt juntos, así que los atajos de Alt no se disparan a través de AltGr.
- **`Ctrl+U` en Chrome** puede abrir "Ver código fuente" en lugar de subrayar (ver [issue #67](https://github.com/Tomanote/TomaNote/issues/67)).
- **`Esc` dentro del editor** deselecciona/cierra la pestaña activa — ¡no te sorprendas!
