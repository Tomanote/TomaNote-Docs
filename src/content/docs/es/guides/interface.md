...
description: Un recorrido por cada zona de la interfaz de TomaNote.
---
...
La estrecha barra lateral izquierda te da acceso rápido a las acciones principales de la app, cada una con su tooltip:

- **Buscar** — abre la paleta de comandos (`Ctrl+K`).
- **Atajos de teclado** — abre la ayuda de atajos (`Alt+/`).
- **Ajustes** — abre el modal de ajustes (`Alt+S`).
...
Tus notas abiertas viven como pestañas en una franja horizontal en la parte superior del área principal:

- Haz clic en una pestaña para cambiar a esa nota.
- Pasa el cursor sobre una pestaña para ver sus botones de **renombrar** y **eliminar**.
- Las pestañas **fijadas** se quedan al frente y conservan su emoji.
...
En escritorio (pantallas de 768 px o más) un panel estático a la derecha aloja las herramientas:

- **+** — crea una nota nueva.
- **Contenido** — rehacer, deshacer, copiar, pegar.
- **Fuente** — negrita, subrayado, cursiva.
- **Pestaña** — fijar, renombrar, eliminar la pestaña activa.

Consulta [Herramientas y barra lateral derecha](/es/guides/tools/) para más detalle.
...
Cuando dejas de escribir, aparece un pequeño indicador **Guardado** en la parte inferior derecha del editor. `Ctrl+S` lo muestra al instante.
